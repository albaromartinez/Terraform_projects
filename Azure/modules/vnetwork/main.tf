...
################################# Create resources for Windows VM #################################
...
# resource "azurerm_network_interface_security_group_association" "windows_nisga" {
...
# Connect the security group to the network interface
resource "azurerm_network_interface_security_group_association" "linux_nisga" {
